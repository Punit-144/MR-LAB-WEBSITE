    ...
    <main className="w-full overflow-x-hidden relative text-black font-poppins flex flex-col gap-32">
      ...
      <section className="w-full mt-28 md:mt-32 text-center px-6 flex flex-col items-center gap-6">
        <h1 className="text-4xl md:text-5xl font-bold text-primary">
          Unreal Training - Immersive Online Sessions
        </h1>
        <p className="max-w-3xl mx-auto text-gray-700 text-sm md:text-base leading-relaxed">
          A 10 days online training opportunity to dive into Unreal Engine
          with expert trainers at IIT Jodhpur.
        </p>
        ...
        <section className="w-[90%] md:w-[30%] mx-auto mt-8">
          <div className="rounded-lg overflow-hidden shadow-md">
        <Image
          src="/Unreal Training.png"
          alt="Unreal Training Program"
          width={800}
          height={500}
      ...
      <section className="w-[90%] md:w-[80%] mx-auto mt-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-700">
          <li>30-hour practical sessions from industry experts</li>
          <li>510+ Mock Tests with 1 Year Accessibility</li>
          <li>10 Days & Capstone project</li>
        </ul>
      </section>
      ...
      <section className="w-[90%] md:w-[80%] mx-auto mt-1 "> {/*original mt was 8*/}
        ...
        <p className="text-sm text-gray-700">
          Exciting Prizes and Course Completion Certificate
        </p>
      </section>  
