    ...
    <main className="w-full overflow-x-hidden relative text-black font-poppins flex flex-col gap-32">
      ...
      <section className="w-full mt-28 md:mt-32 text-center px-6 flex flex-col items-center gap-6">
        <h1 className="text-4xl md:text-5xl font-bold text-primary">
          Summer Training Program - XR Edition
        </h1>
        <p className="max-w-3xl mx-auto text-gray-700 text-sm md:text-base leading-relaxed">
          A one-week residential training opportunity to dive into AI, Robotics,
          XR, and 3D Design with expert trainers at IIT Jodhpur.
        </p>
      ...
      <section className="w-[90%] md:w-[80%] mx-auto mt-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-700">
          <li>One-week intensive training and hands-on workshops</li>
          <li>Accommodation and meals provided</li>
          <li>Guided lab visits and campus tour</li>
          <li>Expert-led industry sessions</li>
      ...
      <section className="w-[90%] md:w-[80%] mx-auto mt-1 "> {/*original mt was 8*/}
        ...
        <p className="text-sm text-gray-700">
          The top 15% of participants will be offered a paid internship with a stipend of ₹10,000 per month.
        </p>
      </section>  
